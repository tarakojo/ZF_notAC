...
lemma ex_iff : "\<And>A P Q. (\<And>x. P(x) \<longleftrightarrow> Q(x)) \<Longrightarrow> (\<exists>x. P(x)) \<longleftrightarrow> (\<exists>x. Q(x))" by auto 
lemma bex_iff : "\<And>A P Q. (\<And>x. x \<in> A \<Longrightarrow> P(x) \<longleftrightarrow> Q(x)) \<Longrightarrow> (\<exists>x \<in> A. P(x)) \<longleftrightarrow> (\<exists>x \<in> A. Q(x))" by auto 
...
lemma notnot_iff : "\<And>P Q. P \<longleftrightarrow> Q \<Longrightarrow> \<not>P \<longleftrightarrow> \<not>Q" by auto
...
lemma union_lt1 : "Ord(n) \<Longrightarrow> Ord(m) \<Longrightarrow> Ord(l) \<Longrightarrow> n < m \<Longrightarrow> n < m \<union> l" 
  apply(rule_tac b=m in lt_le_lt)
  using max_le1 
  by auto
lemma union_lt2 : "Ord(n) \<Longrightarrow> Ord(m) \<Longrightarrow> Ord(l) \<Longrightarrow> n < l \<Longrightarrow> n < m \<union> l" 
  apply(rule_tac b=l in lt_le_lt)
  using max_le2 
  by auto
